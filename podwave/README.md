...
PodWave is not just another podcast app; it's a revolutionary audio experience that transforms the way you discover, enjoy, and interact with your favourite shows. Born from a passion for storytelling and cutting-edge technology, PodWave brings podcasts into a new dimension.
...
# Requirements
    -	Updated Version of windows/MacOs
    -	Node.Js 
...
Github: 
(https://github.com/mclintonsa/BILMAB458_WFO2401_B_Billy-Mabunda_DJS11.git)

# Developer Contact Details

Name: Billy Clinton Mabunda
Email: mclintonsa@gmail.com 
Github: https://github.com/mclintonsa 
